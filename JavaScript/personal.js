...
function renderCards(cards) {
  ...
  cards.forEach((card, index) => {
    ...
    redirectBtn.id = "redireccionarBtn";
    redirectBtn.innerText = "Agendar";
    redirectBtn.addEventListener("click", () => {
      const nombreContacto = document.getElementById("contactName").value;
      window.location.href = `agendaP.html?nombre=${encodeURIComponent(nombreContacto)}`;
    }); 
    ...
    cardElement.appendChild(redirectBtn); // Agregar el botón de redireccionar
